...
module.exports = function () {
    ...
    let is_iOS = /iPad|iPhone|iPod/.test(navigator.appVersion),
        sounds_num = 0,
        settings = {},
        sounds = {},
        i;
    ...
    const createSound = function (obj) {
    ...
    Sound.prototype = {
        ...
        createUrl() {
            const no_cache = new Date().valueOf();
    ...
    let Stream = function (options, sprite_part) {
